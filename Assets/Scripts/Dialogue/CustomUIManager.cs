...
public class CustomUIManager : MonoBehaviour
{
    ...
    void UpdateUI(VD.NodeData data)
    {
        ...
        NPC_Text.text = "";
        //foreach (Button b in maxPlayerChoices) { b.transform.GetChild(0).GetComponent<TMP_Text>().text = ""; b.transform.GetChild(0).GetComponent<TMP_Text>().color = Color.white; }
    ...
    IEnumerator AnimatePlayerText(string[] choices)
    {
        ...
        for (int c = 0; c < choices.Length; c++)
        {
            ...
            TMP_Text txtref = maxPlayerChoices[c].transform.GetChild(0).GetComponent<TMP_Text>();
            txtref.text = "";
